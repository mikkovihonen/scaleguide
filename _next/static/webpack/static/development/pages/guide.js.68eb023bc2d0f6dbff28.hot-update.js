...
function (_Component) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_PageLayout_js__WEBPACK_IMPORTED_MODULE_3__["default"], {
        ...
        onSelectorChange: function onSelectorChange(note, mode, type) {
          var content = me.getEnrichingContent(note + " " + mode);
          console.log(content);
        },
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "Common chord progressions"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: "noPrint",
        style: {
          height: "210px"
        },
  ...
  return Guide;
}(react__WEBPACK_IMPORTED_MODULE_2__["Component"]); //<ReactMarkdown source={ this.props.content.fields.chordProgressions } />
...
//# sourceMappingURL=guide.js.68eb023bc2d0f6dbff28.hot-update.js.map